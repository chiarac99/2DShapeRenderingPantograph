...
void loop() {
  ...
  // 4. Telemetry on Board 1's USB is DISABLED so it doesn't confuse the
  //    Processing GUI (which reads from Board 5's USB only).
  //    Re-enable temporarily by uncommenting the block below if debugging.
  /*
